...
class PackedExpertPool:
    ...
    def run_rows(
        ...
        *,
        ...
        # Kimi's full-resident TP path uses a 4096-row scratch by default;
        ...
        dequant_prefill = bool(self._dequant_supported(layer))
        ...
        packed_grouped_prefill = _select_packed_grouped_prefill(
            ...
            dequant_prefill=dequant_prefill,
            hip_runtime=torch.version.hip is not None,
        )
        if packed_grouped_prefill:
        ...
        if len(self.devices) == 1:
            if dequant_prefill or packed_grouped_prefill:
